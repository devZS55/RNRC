...
<div class="py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Un-Assigned-Appointments</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">Un-Assigned-Appointments-List</h1>
        </div>
        <!-- <div>
        ...
        <div class="table-responsive">
            <table class="table table-centered table-nowrap mb-0 rounded" id="table_id">
                ...
                <tbody>
                    <!-- Item -->
                        <!-- Start of Item -->
                        @foreach($un_assigned as $key=>$assign)
                            <tr>
